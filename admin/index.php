...
<head>
    ...
    <title>Richard's Lab: Admin Dashboard</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
										 <h5>Selamat datang di sistem informasi Penerimaan Peserta Didik Baru (PPDB) Online.
                                         <br>Sistem ini disusun oleh Richard's Lab</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
