...
<!------------------ Pisahin ------------------->
                                    ...
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['jeniskelamin']?>" disabled>
                                            </select>
                                            </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['ayahpendidikan']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Pekerjaan Ayah</label>
                                                <input type="text" class="form-control" value="<?php echo $ambil['ayahpekerjaan']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['ayahpenghasilan']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['ibupendidikan']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                <label>Pekerjaan Ibu</label>
                                                <input type="text" class="form-control" value="<?php echo $ambil['ibupekerjaan']?>" disabled>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['ibupenghasilan']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $ambil['walipekerjaan']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                        ...
                                                        <img src="../user/<?php echo $ambil['scanijazahdepan']?>" width="50%">
                                                    </div>
                                                </div>
                                            <div class="col">
                                                <div class="form-group">
                                                        <label for="scanijazahbelakang" class=" form-control-label">Scan Ijazah Bagian Belakang</label>
                                                        <img src="../user/<?php echo $ambil['scanijazahbelakang']?>" width="50%">
                                                </div>
                                            </div>
                                        </div>
        ...
        <footer>
            <div class="footer-area">
                <p>PPDB Online by Alif Bima Pradana</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
